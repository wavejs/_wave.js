...
/**
 * 객체의 프로퍼티를 확장합니다.
 * 실제 역할은 _moduleExtendCore()에 proto 옵션을 비활성하여 호출하는 형태입니다.
 * property만 확장
 *
 * @function moduleExtend
 * @memberOf module:base
 * 
 * @param {function|object} dst 확장 대상이 될 객체입니다.
 * @param {object} src 확장할 함수 집합의 객체, n개의 매개변수를 가질 수 있습니다.
 * @return {function|object} 확장된 destination 객체를 반환합니다.
 */
exports.moduleExtend = function (/* dst, src */) {
  var args = [false];
 ...
 * 실제 역할은 _moduleExtendCore()에 proto 옵션을 활성하여 호출하는 형태입니다.
 * property와 prototype을 확장
 *
 * @function moduleExtendDeep
 * @memberOf module:base
 * 
 * @param {function|object} dst 확장 대상이 될 객체입니다.
 * @param {object} src 확장할 함수 집합의 객체, n개의 매개변수를 가질 수 있습니다.
 * @return {function|object} 확장된 destination 객체를 반환합니다.
 */
exports.moduleExtendDeep = function (/* dst, src */) {
  var args = [true];
